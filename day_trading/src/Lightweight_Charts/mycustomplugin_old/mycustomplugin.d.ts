...
declare class MycustompluginRenderer<TData extends MycustompluginData> implements ICustomSeriesPaneRenderer {
	...
	_options: MycustompluginOptions | null;
	draw(target: CanvasRenderingTarget2D, priceConverter: PriceToCoordinateConverter): void;
	update(data: PaneRendererCustomData<Time, TData>, options: MycustompluginOptions): void;
	_drawImpl(renderingScope: BitmapCoordinatesRenderingScope, priceToCoordinate: PriceToCoordinateConverter): void;
}
export declare class Mycustomplugin<TData extends MycustompluginData> implements ICustomSeriesPaneView<Time, TData, MycustompluginOptions> {
	...
	update(data: PaneRendererCustomData<Time, TData>, options: MycustompluginOptions): void;
	defaultOptions(): MycustompluginOptions;
}
